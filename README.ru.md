...
> Вставьте скриншот главного меню
...
> Вставьте скриншот окна поиска и бронирования
...
> Вставьте скриншот окна активных бронирований

```text
assets/screenshots/bookings.png
```
...
> Вставьте скриншот окна привязки Telegram

```text
assets/screenshots/telegram.png
```
